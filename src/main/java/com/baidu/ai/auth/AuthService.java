...
public class AuthService {
    ...
    public String getAuth() {
        ...
        String clientId = cache.get(AIConsts.CLIENT_ID);
        // 官网获取的 Secret Key 更新为你注册的
        String clientSecret = cache.get(AIConsts.CLIENT_SECRET);
    ...
    public  String getAuth(String ak, String sk) {
        ...
        try {
            ...
            ConfigItem configItem = new ConfigItem(AIConsts.ACCESS_TOKEN, accessToken, AIConsts.ACCESS_TOKEN);
